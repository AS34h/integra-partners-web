    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6">
          <motion.div {...fadeInUp} className="prose max-w-none space-y-12">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  ...
                  notre <a href="/confidentialite" className="text-gold hover:text-gold-dark underline font-semibold">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p>
                  ...
                  <a href="/cookies" className="text-gold hover:text-gold-dark underline font-semibold">
