...
import { FileText, BookOpen, Award, ChevronRight } from 'lucide-react'
      ...
      <section className="bg-white py-16 md:py-24">
        <div className="container mx-auto">
          <motion.div 
            ...
            {...fadeInUp}
          >
            <Card variant="custom" className="p-8 md:p-12 border-gold">
              <h2 className="font-heading text-h2 text-navy mb-4 text-center">
                Newsletter Stratégique
              </h2>
              <p className="text-body-l text-anthracite mb-8 text-center">
                Recevez nos analyses, études de cas et insights stratégiques 
                directement dans votre boîte mail. Publication mensuelle.
              </p>
              <form className="flex flex-col sm:flex-row gap-4">
                <input 
                  type="email"
                  placeholder="votre.email@entreprise.com"
                  className="flex-1 px-6 py-4 rounded border border-gray-300 focus:border-navy focus:outline-none"
                />
