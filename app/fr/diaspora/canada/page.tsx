...
import { MapPin, Building2, TrendingUp, Banknote } from 'lucide-react'
...
const intentions = [
  {
    ...
    description: 'Création d\'entreprise 100% à distance depuis le Canada. Signature notaire, procuration, délai 15-20 jours.',
    prix: '1 200 CAD'
  },
  {
    icon: TrendingUp,
    ...
    description: 'Immobilier, PME, foncier. Audit juridique, structuration fiscale, gestion déléguée.',
    prix: '800 CAD'
  },
  {
    icon: Banknote,
    slug: 'transferts',
    titre: 'Optimiser Transferts CAD→XOF',
    description: 'Réduction des frais bancaires, conformité, structuration flux financiers.',
    prix: '150 CAD'
  }
]
        ...
        <div className="container mx-auto px-4">
          <motion.div {...fadeInImmediate} className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#0B1A3E] mb-4">
              Vos Projets au Togo depuis le Canada
            </h2>
            <p className="text-gray-700 max-w-2xl mx-auto">
              Contenu SEO à venir : statistiques diaspora Canada-Togo, transferts, opportunités.
            </p>
          </motion.div>
            ...
            {intentions.map((intention, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <Link href={`/fr/diaspora/canada/${intention.slug}`}>
