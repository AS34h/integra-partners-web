        ...
        <div className="container mx-auto px-4">
          <motion.div {...fadeInImmediate} className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Modèles de <span className="text-[#B8860B]">Documents</span>
            </h1>
            
            <p className="text-xl text-gray-300 mb-8">
              Templates téléchargeables : statuts, pactes, PV, contrats, conformes OHADA.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <Card variant="custom" className="p-12 text-center">
              <FileText className="w-16 h-16 text-[#B8860B] mx-auto mb-6" />
              <h2 className="text-2xl font-bold text-[#0B1A3E] mb-4">
                Modèles à Venir
              </h2>
              <p className="text-gray-700 mb-6">
                Nous préparons une bibliothèque de templates professionnels : 
                statuts SARL/SA, pactes d'associés, PV AG, contrats cadres.
              </p>
