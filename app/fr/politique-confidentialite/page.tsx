              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <p className="text-sm">
                      Hébergement web (Vercel), solution d'analyse privacy-first (Plausible Analytics),
                      service d'emailing (sous-traitants), agissant en qualité de sous-traitants et soumis à nos instructions.
                    </p>
                  </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <strong>Union Européenne :</strong> Pour l'hébergement web (Vercel) et l'analyse respectueuse de la vie privée (Plausible Analytics, serveurs UE)
                  </li>
                  <li>
                    <strong>États-Unis :</strong> Pour certains services d'infrastructure cloud (avec garanties appropriées)
                  </li>
                  <li>
                    <strong>Autres pays :</strong> Selon les outils utilisés pour nos missions (avec encadrement juridique)
                  </li>
                </ul>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse">
                    ...
                    <tbody className="divide-y divide-gray-200">
                      ...
                      <tr className="bg-gray-50">
                        <td className="px-4 py-3 text-gray-700">Données analytiques (anonymisées)</td>
                        <td className="px-4 py-3 text-gray-700">26 mois maximum (Plausible Analytics)</td>
                      </tr>
                      <tr>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  ...
                  <Link href="/fr/cookies" className="text-gold hover:text-gold-dark underline font-semibold">
